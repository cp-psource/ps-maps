...
jQuery(function() {
    ...
    function advanced_mode_on() {
        ...
        // Bind events
        jQuery('.maps_merge_locations', wnd).on("click", adv_merge_locations);
        jQuery('.maps_batch_delete', wnd).on("click", adv_confirm_batch_delete);
    ...
    function advanced_mode_off() {
        ...
        jQuery('.maps_merge_locations', wnd).off('click');
        jQuery('.maps_batch_delete', wnd).off('click');
