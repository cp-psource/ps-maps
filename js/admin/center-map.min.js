    ...
    if (void 0 !== window._agm) {
        var a = jQuery(document),
            ...
            g = function() {
                if (null === b) return !1;
                var a = b.getCenter();
                null !== c && c.setMap(null), c = new window.google.maps.marker.AdvancedMarkerElement({ title: "Center", map: b, icon: d, draggable: !0, clickable: !1, position: a, zIndex: 999 }), c.setMap(b)
            },
