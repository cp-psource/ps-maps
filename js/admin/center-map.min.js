...
jQuery(function() { if (void 0 !== window._agm) { var a = jQuery(document),
            b = null,
            c = null,
            d = _agm.root_url + "/img/system/map_center.png",
            e = function(a, d, e) { if (b = d, null !== c && (c.setMap(null), c = null), void 0 !== e.map_center) { var f = new window.google.maps.LatLng(e.map_center[0], e.map_center[1]);
                    d.setCenter(f), g() } },
            f = function(a, b, c) { var e = jQuery("#agm_map_drop_marker", b),
                    f = jQuery('<button type="button" class="button-secondary"></button>');
                f.text("Set Center"), f.prepend('<img src="' + d + '" style="height:20px;margin:3px;vertical-align:top" />'), f.insertAfter(e), f.on("click", g) },
            g = function() { if (null === b) return !1; var a = b.getCenter();
