...
(function($) {
    ...
    var Galleria = function() {
        ...
        var fullscreen = this._fullscreen = {
            ...
            exit: function(callback) {
                ...
                $(window).off('resize', fullscreen.scale);
            }
        };
        ...
        var lightbox = this._lightbox = {
            ...
            init: function() {
                ...
                hover($(el.close).on(CLICK(), lightbox.hide).html('&#215;'));
                ...
                $(el.overlay).on(CLICK(), lightbox.hide);
            ...
            hide: function() {
                ...
                $(window).off('resize', lightbox.rescale);
    ...
    Galleria.prototype = {
        ...
        */
        ...
        _init: function() {
            ...
            this.on(Galleria.DATA, function() {
            ...
            this.on(Galleria.READY, (function(one) {
                ...
                return function() {
                    ...
                    if (this._options.clicknext) {
                        ...
                        this.$('stage').css({ cursor: 'pointer' }).on(CLICK(), function(e) {
                            self.next();
                        });
                    }
            ...
            this.$('image-nav-right, image-nav-left').on(CLICK(), function(e) {
            ...
            if (this._options.carousel) {
                this.on(Galleria.THUMBNAIL, function() {
                    this.updateCarousel();
                });
            }
    ...
    */
        ...
        /**
            ...
            @example this.on( 'image', function() { Galleria.log('image shown') });
    ...
    */
        ...
        */
        ...
        /**
            ...
            @example $('#fullscreen').on("click",  this.proxy(function() { this.enterFullscreen(); }) )
